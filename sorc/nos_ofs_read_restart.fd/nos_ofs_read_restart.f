!--------------------------------------------------------------------------
!
!  Program Name: nos_ofs_read_restart.f
!
!  Contact: NOS/CO-OPS Aijun Zhang
!           Phone: 240-533-0591   Email: aijun.zhang@noaa.gov
!
!  Abstract:  This program read the ROMS-base restart NetCDF file.
!
!  History Log:
!           03/29/2019
!  Usage:
!
!    nos_ofs_read_restart < Fortran_read_restart.ctl 
!    Where the control file Fortran_read_restart.ctl is generated by
!    script nos_ofs_launch.sh
!
