...
!epm next section added for outputs of initial conditions
it=iths
time=iths*dt
do j=1,noutput
...
!Vertical profiles
                  do k=1,nvrt
                    ...
                    enddo !m
                    if (swild4(1,1).lt.(-9000) .or. swild4(1,2).lt.(-9000) .or. swild4(1,3).lt.(-9000)) then
                      zta_out3d(k,i,j)=-9999.
                      sta_out3d(k,i,j)=-9999.
                    else
...
!epm end section added for outputs of initial conditions
...
sdbt(3,j,isd0)=swild3(1)  !ttint AJ bug fixes according to SELFE web page 03/31/2017
