...
!
!svn $Id: mp_exchange.F 857 2017-07-29 04:05:27Z arango $
!================================================== Hernan G. Arango ===
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 60, 359,                               &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 60, 890,                              &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange2d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 63, 967,                               &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 63, 1392,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange2d_bry")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 61, 1473,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 61, 2103,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange3d")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 63, 2180,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 63, 2718,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange3d_bry")
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 62, 2802,                              &
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 62, 3391,                             &
     &                 "ROMS/Utility/mp_exchange.F"//":mp_exchange4d")
      RETURN
