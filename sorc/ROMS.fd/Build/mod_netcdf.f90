      MODULE mod_netcdf
!
!svn $Id: mod_netcdf.F 857 2017-07-29 04:05:27Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                                    dim_name(i), dim_size(i))
            IF (FoundError(status, nf90_noerr, 302,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_get_dim")) THEN
     ...
     &                          TRIM(SourceFile)
        ...
        ELSE
          IF (n_dim.gt.Mdims) THEN
            ...
            ioerror=0
          END IF
          IF (FoundError(status, nf90_noerr, 324,                       &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_dim")) THEN
...
!
      ...
      IF (FoundError(exit_flag, NoError, 654,                           &
     &               "ROMS/Modules/mod_netcdf.F" //                     &
...
!
     ...
     &                            IvarS)
            IF (FoundError(exit_flag, NoError, 669,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_check_var")) RETURN
     ...
     &                                      TRIM(ncname)
          ...
          CASE ('theta_b')
            CALL netcdf_get_fvar (ng, IDmod, ncname, var_name(i),       &
     &                            FvarS)
            IF (FoundError(exit_flag, NoError, 721,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_check_var")) RETURN
     ...
     &                          TRIM(SourceFile)
        ...
        ELSE
          IF (n_var.gt.Mvars) THEN
            ...
            exit_flag=2
          END IF
          IF (FoundError(status, nf90_noerr, 1300,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_inq_var")) THEN
...
!
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    var_Aint(i))
                      IF (FoundError(status, nf90_noerr, 1409,          &
     &                               "ROMS/Modules/mod_netcdf.F" //     &
     &                               ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    var_Afloat(i))
                      IF (FoundError(status, nf90_noerr, 1427,          &
     &                               "ROMS/Modules/mod_netcdf.F" //     &
     &                               ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    text(1:my_Alen))
                      IF (FoundError(status, nf90_noerr, 1443,          &
     &                               "ROMS/Modules/mod_netcdf.F" //     &
     &                               ", netcdf_inq_var")) THEN
...
!
      IF (InpThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 1599,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 1693,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
     ...
     &                                AttValue(i))
                  IF (FoundError(status, nf90_noerr, 1728,              &
     &                           "ROMS/Modules/mod_netcdf.F" //         &
            ...
            IF (status.eq.nf90_noerr) THEN
              DO i=1,nvatts
                IF (TRIM(my_Aname).eq.TRIM(AttName(i))) THEN
                  status=nf90_get_att(my_ncid, varid, TRIM(AttName(i)), &
     &                                AttValue(i))
                  IF (FoundError(status, nf90_noerr, 1911,              &
     &                           "ROMS/Modules/mod_netcdf.F" //         &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2069,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 2087,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2257,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2469,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2486,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2702,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2719,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2946,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2963,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3174,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 3216,                    &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3347,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_lvar")) RETURN
      ELSE
        my_ncid=ncid
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 3392,                    &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_get_lvar")) THEN
              WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),          &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3519,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3537,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3654,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_ivar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3671,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3789,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_ivar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3806,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3922,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3939,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4056,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_svar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4073,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 4190,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          ...
          IF (FoundError(status, nf90_noerr, 4202,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 4223,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4331,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4343,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 4359,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4467,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4479,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 4495,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4603,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4615,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 4631,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4739,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4751,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 4767,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4877,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4889,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          ELSE
            ...
            status=nf90_put_var(my_ncid, my_varid, my_A, start, total)
          END IF
          IF (FoundError(status, nf90_noerr, 4910,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5018,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_ivar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5030,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 5046,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5154,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_ivar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5166,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 5182,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5296,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5308,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 5338,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5451,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_lvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5463,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 5490,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5603,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_lvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5615,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, AI, start, total)
          IF (FoundError(status, nf90_noerr, 5644,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5753,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5765,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 5783,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5893,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_svar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5905,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          mytotal(2)=total(1)
          status=nf90_put_var(my_ncid, my_varid, A, mystart, mytotal)
          IF (FoundError(status, nf90_noerr, 5925,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 6092,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_close")) THEN
...
!
      ...
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6199,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_create")) THEN
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6285,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_enddef")) THEN
      ...
      IF (InpThread) THEN
        SELECT CASE (omode)
          ...
          CASE DEFAULT
            status=nf90_open(TRIM(ncname), nf90_nowrite, ncid)
        END SELECT
        IF (FoundError(status, nf90_noerr, 6406,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_open")) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          exit_flag=3
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6486,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_redef")) THEN
          IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          exit_flag=3
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6562,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_sync")) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          exit_flag=3
