      MODULE def_var_mod
!
!svn $Id: def_var.F 857 2017-07-29 04:05:27Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                            Vdim(1:nVdim), Vid)
            END IF
            IF (FoundError(status, nf90_noerr, 139,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          'grid_topology')
            IF (FoundError(status, nf90_noerr, 180,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          (/2/))
            IF (FoundError(status, nf90_noerr, 191,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          'xi_psi eta_psi')
            IF (FoundError(status, nf90_noerr, 202,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          TRIM(text))
            IF (FoundError(status, nf90_noerr, 227,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            'lon_psi lat_psi')
              IF (FoundError(status, nf90_noerr, 251,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
     ...
     &                            'lon_rho lat_rho')
              IF (FoundError(status, nf90_noerr, 262,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
     ...
     &                            'lon_u lat_u')
              IF (FoundError(status, nf90_noerr, 273,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
     ...
     &                                        TRIM(ncname)
            ...
            ELSE
              status=nf90_put_att(ncid, Vid, 'node_coordinates',        &
     &                            'x_psi y_psi')
              IF (FoundError(status, nf90_noerr, 295,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
                IF (Master) WRITE (stdout,30) 'node_coordinates',       &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
              ...
              status=nf90_put_att(ncid, Vid, 'face_coordinates',        &
     &                            'x_rho y_rho')
              IF (FoundError(status, nf90_noerr, 306,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
                IF (Master) WRITE (stdout,30) 'face_coordinates',       &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
              ...
              status=nf90_put_att(ncid, Vid, 'edge1_coordinates',       &
     &                            'x_u y_u')
              IF (FoundError(status, nf90_noerr, 317,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
                IF (Master) WRITE (stdout,30) 'edge1_coordinates',      &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
              ...
              status=nf90_put_att(ncid, Vid, 'edge2_coordinates',       &
     &                            'x_v y_v')
              IF (FoundError(status, nf90_noerr, 328,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
                IF (Master) WRITE (stdout,30) 'edge2_coordinates',      &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
...
!
     ...
     &                          Vinfo(19)(1:latt))
            IF (FoundError(status, nf90_noerr, 379,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          Vinfo(4)(1:latt))
            IF (FoundError(status, nf90_noerr, 417,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            Aval(2))
            END IF
            IF (FoundError(status, nf90_noerr, 445,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            Aval(3))
            END IF
            IF (FoundError(status, nf90_noerr, 474,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            text(1:latt))
              IF (FoundError(status, nf90_noerr, 501,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            (/0.0_r8, 1.0_r8/))
            ...
            IF (status.eq.nf90_noerr) THEN
              ...
              status=nf90_put_att(ncid, Vid, 'flag_meanings',           &
     &                            text(1:latt))
              IF (FoundError(status, nf90_noerr, 542,                   &
     &                       "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          Vinfo(11)(1:latt))
            IF (FoundError(status, nf90_noerr, 567,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          Vinfo(15)(1:latt))
            IF (FoundError(status, nf90_noerr, 639,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          Vinfo(16)(1:latt))
            IF (FoundError(status, nf90_noerr, 657,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            Aval(4))
            END IF
            IF (FoundError(status, nf90_noerr, 685,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            Aval(6))
            END IF
            IF (FoundError(status, nf90_noerr, 743,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          Vinfo(20)(1:latt))
            IF (FoundError(status, nf90_noerr, 762,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          TRIM(location))
            IF (FoundError(status, nf90_noerr, 887,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                          Vinfo(14)(1:latt))
            IF (FoundError(status, nf90_noerr, 941,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
...
!
     ...
     &                            REAL(spval,r4))
            END IF
            IF (FoundError(status, nf90_noerr, 977,                     &
     &                     "ROMS/Utility/def_var.F")) THEN
