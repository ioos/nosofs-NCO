      MODULE prsgrd_mod
!
!svn $Id: prsgrd.F 830 2017-01-24 21:21:11Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 23, 52, "ROMS/Nonlinear/prsgrd32.h")
     ...
     &                  OCEAN(ng) % ru,                                 &
     &                  OCEAN(ng) % rv)
      CALL wclock_off (ng, iNLM, 23, 82, "ROMS/Nonlinear/prsgrd32.h")
      RETURN
