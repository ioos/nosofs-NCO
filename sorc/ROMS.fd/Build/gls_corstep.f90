...
!
!svn $Id: gls_corstep.F 855 2017-07-29 03:10:57Z arango $
!=======================================================================
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 19, 50, "ROMS/Nonlinear/gls_corstep.F")
     ...
     &                       MIXING(ng) % gls,                          &
     &                       MIXING(ng) % tke)
      CALL wclock_off (ng, iNLM, 19, 90, "ROMS/Nonlinear/gls_corstep.F")
      RETURN
