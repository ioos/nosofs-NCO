...
!
!svn $Id: set_depth.F 854 2017-07-18 23:28:45Z arango $
!=======================================================================
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 12, 54, "ROMS/Nonlinear/set_depth.F")
     ...
     &                     GRID(ng) % z_r,                              &
     &                     GRID(ng) % z_w)
      CALL wclock_off (ng, model, 12, 72, "ROMS/Nonlinear/set_depth.F")
      RETURN
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 12, 314, "ROMS/Nonlinear/set_depth.F")
     ...
     &                      GRID(ng) % z0_r,                            &
     &                      GRID(ng) % z0_w)
      CALL wclock_off (ng, model, 12, 326, "ROMS/Nonlinear/set_depth.F")
      RETURN
