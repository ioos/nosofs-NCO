     ...
     &                          rectangular)
!
!svn $Id: get_varcoords.F 857 2017-07-29 04:05:27Z arango $
!================================================== Hernan G. Arango ===
...
!
      SourceFile="ROMS/Utility/get_varcoords.F"
!
!-----------------------------------------------------------------------
...
!
     ...
     &               "ROMS/Utility/get_varcoords.F")) RETURN
!
...
!
     ...
     &                     myVarName = Yname,                           &
     &                     VarID= varid)
      IF (FoundError(exit_flag, NoError, 167,                           &
     &               "ROMS/Utility/get_varcoords.F")) RETURN
!
      IF (n_vdim.eq.1) THEN
