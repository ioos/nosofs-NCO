      MODULE rho_eos_mod
!
!svn $Id: rho_eos.F 854 2017-07-18 23:28:45Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 14, 66, "ROMS/Nonlinear/rho_eos.F")
     ...
     &                   OCEAN(ng) % pden,                              &
     &                   OCEAN(ng) % rho)
      CALL wclock_off (ng, model, 14, 99, "ROMS/Nonlinear/rho_eos.F")
      RETURN
