...
!
!svn $Id: bulk_flux.F 858 2017-07-31 23:02:30Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 17, 82, "ROMS/Nonlinear/bulk_flux.F")
     ...
     &                     FORCES(ng) % sustr,                          &
     &                     FORCES(ng) % svstr)
      CALL wclock_off (ng, iNLM, 17, 133, "ROMS/Nonlinear/bulk_flux.F")
      RETURN
