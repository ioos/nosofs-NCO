...
!
!svn $Id: check_multifile.F 857 2017-07-29 04:05:27Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      IF (FoundError(exit_flag, NoError, 372,                           &
     &               "ROMS/Utility/check_multifile.F")) RETURN
!
...
!
     ...
     &                     nVarDim = nvdim,                             &
     &                     nVarAtt = nvatt)
      IF (FoundError(exit_flag, NoError, 406,                           &
     &               "ROMS/Utility/check_multifile.F")) RETURN
!
...
!
     ...
     &                      start = (/Nrec/),                           &
     &                      total = (/1/))
      IF (FoundError(exit_flag, NoError, 458,                           &
     &               "ROMS/Utility/check_multifile.F")) RETURN
