...
!
!svn $Id: def_station.F 858 2017-07-31 23:02:30Z arango $
!================================================== Hernan G. Arango ===
...
!
      SourceFile="ROMS/Utility/def_station.F"
!
!-----------------------------------------------------------------------
...
!
     ...
     &               "ROMS/Utility/def_station.F")) RETURN
      ncname=STA(ng)%name
!
      IF (Master) THEN
        IF (ldef) THEN
...
!
     ...
     &                 "ROMS/Utility/def_station.F")) THEN
...
!
     ...
     &                 N(ng), DimIDs( 9))
        IF (FoundError(exit_flag, NoError, 108,                         &
     &                 "ROMS/Utility/def_station.F")) RETURN
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 298,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 330,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 364,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 396,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 412,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 444,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                     SetFillVal = .TRUE.,                         &
     &                     SetParAccess = .FALSE.)
            IF (FoundError(exit_flag, NoError, 468,                     &
     &                     "ROMS/Utility/def_station.F")) RETURN
          END IF
        END DO
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 485,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 538,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 590,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 642,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 676,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 732,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 770,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 790,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 808,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 844,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 876,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
...
!
     ...
     &                   SetFillVal = .TRUE.,                           &
     &                   SetParAccess = .FALSE.)
          IF (FoundError(exit_flag, NoError, 892,                       &
     &                   "ROMS/Utility/def_station.F")) RETURN
        END IF
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1546,                        &
     &                 "ROMS/Utility/def_station.F")) RETURN
      END IF DEFINE
!
!=======================================================================
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1574,                        &
     &                 "ROMS/Utility/def_station.F")) THEN
