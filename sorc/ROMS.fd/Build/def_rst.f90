...
!
      IF (FoundError(exit_flag, NoError, 86,                            &
...
!
     ...
     &                 N(ng), DimIDs( 9))
        IF (FoundError(exit_flag, NoError, 199,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
     ...
     &                 nf90_unlimited, DimIDs(12))
        IF (FoundError(exit_flag, NoError, 282,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
        recdim=DimIDs(12)
!
...
!
     ...
     &                 1, (/recdim/), Aval, Vinfo, ncname,              &
     &                 SetParAccess = .FALSE.)
        IF (FoundError(exit_flag, NoError, 588,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
        Vinfo( 1)='nnew'
     ...
     &                 1, (/recdim/), Aval, Vinfo, ncname,              &
     &                 SetParAccess = .FALSE.)
        IF (FoundError(exit_flag, NoError, 604,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
        Vinfo( 1)='krhs'
     ...
     &                 1, (/recdim/), Aval, Vinfo, ncname,              &
     &                 SetParAccess = .FALSE.)
        IF (FoundError(exit_flag, NoError, 612,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
        Vinfo( 1)='knew'
...
!
     ...
     &                 SetParAccess = .FALSE.)
        IF (FoundError(exit_flag, NoError, 634,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, r2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 784,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, u2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 812,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, rv2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 888,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd5, ru3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 944,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd5, v3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 972,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd5, rv3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 999,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                   NF_FRST, nvd5, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1035,                      &
     &                   "ROMS/Utility/def_rst.F")) RETURN
        END DO
!
...
!
     ...
     &                 SetFillVal = .FALSE.)
        IF (FoundError(exit_flag, NoError, 1147,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 SetFillVal = .FALSE.)
        IF (FoundError(exit_flag, NoError, 1198,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, w3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 1257,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1552,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
      END IF DEFINE
!
!=======================================================================
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1580,                        &
     &                 "ROMS/Utility/def_rst.F")) THEN
