...
!
!svn $Id: inp_par.F 858 2017-07-31 23:02:30Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      IF (FoundError(exit_flag, NoError, 1114,                          &
     &               "ROMS/Utility/inp_par.F")) RETURN
!
!-----------------------------------------------------------------------
...
!
      ...
      integer :: ncid
!
      SourceFile="ROMS/Utility/inp_par.F" // ", find_file"
!
!-----------------------------------------------------------------------
