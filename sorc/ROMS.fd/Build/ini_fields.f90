...
!
!svn $Id: ini_fields.F 854 2017-07-18 23:28:45Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 2, 50, "ROMS/Nonlinear/ini_fields.F")
     ...
     &                      OCEAN(ng) % vbar,                           &
     &                      OCEAN(ng) % zeta)
      CALL wclock_off (ng, iNLM, 2, 96, "ROMS/Nonlinear/ini_fields.F")
      RETURN
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 2, 799, "ROMS/Nonlinear/ini_fields.F")
     ...
     &                    COUPLING(ng) % Zt_avg1,                       &
     &                    OCEAN(ng) % zeta)
      CALL wclock_off (ng, iNLM, 2, 822, "ROMS/Nonlinear/ini_fields.F")
      RETURN
