...
!
!svn $Id: set_masks.F 854 2017-07-18 23:28:45Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 2, 58, "ROMS/Utility/set_masks.F")
     ...
     &                     GRID(ng) % umask_full,                       &
     &                     GRID(ng) % vmask_full)
      CALL wclock_off (ng, model, 2, 87, "ROMS/Utility/set_masks.F")
      RETURN
