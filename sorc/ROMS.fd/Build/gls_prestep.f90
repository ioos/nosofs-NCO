...
!
!svn $Id: gls_prestep.F 854 2017-07-18 23:28:45Z arango $
!=======================================================================
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 19, 47, "ROMS/Nonlinear/gls_prestep.F")
     ...
     &                       MIXING(ng) % gls,                          &
     &                       MIXING(ng) % tke)
      CALL wclock_off (ng, iNLM, 19, 66, "ROMS/Nonlinear/gls_prestep.F")
      RETURN
