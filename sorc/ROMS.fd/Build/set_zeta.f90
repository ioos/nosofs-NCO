      MODULE set_zeta_mod
!
!svn $Id: set_zeta.F 854 2017-07-18 23:28:45Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 12, 41, "ROMS/Nonlinear/set_zeta.F")
      CALL set_zeta_tile (ng, tile,                                     &
     &                    LBi, UBi, LBj, UBj,                           &
     &                    IminS, ImaxS, JminS, JmaxS,                   &
     &                    COUPLING(ng) % Zt_avg1,                       &
     &                    OCEAN(ng) % zeta)
      CALL wclock_off (ng, iNLM, 12, 49, "ROMS/Nonlinear/set_zeta.F")
      RETURN
