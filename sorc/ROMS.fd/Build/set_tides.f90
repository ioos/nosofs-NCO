...
!
!svn $Id: set_tides.F 855 2017-07-29 03:10:57Z arango $
!================================================== Hernan G. Arango ===
!  Copyright (c) 2002-2017 The ROMS/TOMS Group        Robert Hetland   !
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 11, 55, "ROMS/Nonlinear/set_tides.F")
     ...
     &                     TIDES(ng) % UV_Tminor,                       &
     &                     TIDES(ng) % Tperiod)
      CALL wclock_off (ng, iNLM, 11, 105, "ROMS/Nonlinear/set_tides.F")
      RETURN
