...
!
!svn $Id: nf_fread3d.F 857 2017-07-29 04:05:27Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                      AttValue, foundit,                          &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 622,                           &
     &               "ROMS/Utility/nf_fread3d.F")) THEN
        nf_fread3d=ioerror
        RETURN
      END IF
...
!
      ...
      Amax=-spval
        ...
        IF (FoundError(status, nf90_noerr, 754,                         &
     &                 "ROMS/Utility/nf_fread3d.F")) THEN
          exit_flag=2
          ioerror=status
          nf_fread3d=status
