...
!
!svn $Id: inquiry.F 858 2017-07-31 23:02:30Z arango $
!================================================== Hernan G. Arango ===
...
!
      SourceFile="ROMS/Utility/inquiry.F"
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 160,                         &
     &                 "ROMS/Utility/inquiry.F")) RETURN
!
...
!
     ...
     &                    Tstr, Tend, Tmin, Tmax,  Tscale)
          IF (FoundError(exit_flag, NoError, 292,                       &
     &                   "ROMS/Utility/inquiry.F")) RETURN
        END IF
!
