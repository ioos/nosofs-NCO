      MODULE uv3dmix_mod
!
!svn $Id: uv3dmix.F 830 2017-01-24 21:21:11Z arango $
!================================================== Hernan G. Arango ===
...
!
!svn $Id: uv3dmix2_s.h 854 2017-07-18 23:28:45Z arango $
!************************************************** Hernan G. Arango ***
!  Copyright (c) 2002-2017 The ROMS/TOMS Group                         !
!    Licensed under a MIT/X style license                              !
!    See License_ROMS.txt                                              !
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 30, 53, "ROMS/Nonlinear/uv3dmix2_s.h")
     ...
     &                    OCEAN(ng) % u,                                &
     &                    OCEAN(ng) % v)
      CALL wclock_off (ng, iNLM, 30, 93, "ROMS/Nonlinear/uv3dmix2_s.h")
      RETURN
