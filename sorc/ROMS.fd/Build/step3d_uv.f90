...
!
!svn $Id: step3d_uv.F 854 2017-07-18 23:28:45Z arango $
!=======================================================================
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 34, 49, "ROMS/Nonlinear/step3d_uv.F")
     ...
     &                     GRID(ng) % Huon,                             &
     &                     GRID(ng) % Hvom)
      CALL wclock_off (ng, iNLM, 34, 100, "ROMS/Nonlinear/step3d_uv.F")
      RETURN
