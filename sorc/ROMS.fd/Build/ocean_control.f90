...
!
!svn $Id: nl_ocean.h 858 2017-07-31 23:02:30Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                 "ROMS/Drivers/nl_ocean.h")) RETURN
!
...
!$OMP PARALLEL
          DO thread=MyRank,MyRank
            CALL wclock_on (ng, iNLM, 0, 145, "ROMS/Drivers/nl_ocean.h")
          END DO
!$OMP END PARALLEL
        END DO
!
...
!$OMP END PARALLEL
      IF (FoundError(exit_flag, NoError, 274,                           &
     &               "ROMS/Drivers/nl_ocean.h")) RETURN
!
...
!$OMP PARALLEL
        DO thread=MyRank,MyRank
          CALL wclock_off (ng, iNLM, 0, 374, "ROMS/Drivers/nl_ocean.h")
        END DO
!$OMP END PARALLEL
      END DO
!
